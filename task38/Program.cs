...
double[] array = CreateArrayRndDouble(7, 1.2, 10.2);
PrintArrayDouble(array);
double maxValue = MaxValue(array);
double minValue = MinValue(array);
double margin = Math.Round(maxValue - minValue, 1);
Console.WriteLine($"Максимальное значение = {maxValue}, минимальное значение = {minValue}");
Console.WriteLine($"Разница между максимальным и минимальным значением = {margin}");